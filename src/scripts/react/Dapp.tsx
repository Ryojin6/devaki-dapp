        ...
        :
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              You can interact with the smart-contract <strong>directly</strong> through <a href={this.generateContractUrl()} target="_blank">{this.state.networkConfig.blockExplorer.name}</a>
              <br />
            </div>

            {!this.isWalletConnected() || this.state.isWhitelistMintEnabled ?
              <div className="merkle-proof-manual-address">
                <h2>Verify Whitelist Wallet</h2>
                <p>
                  Whitelist will be live <strong>AFTER</strong> public mint.
                </p>
